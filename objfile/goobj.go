...
import (
	...
	"github.com/stevemk14ebr/GoReSym/archive"
	...
	"github.com/stevemk14ebr/GoReSym/objabi"
	"github.com/stevemk14ebr/GoReSym/sys"
)
...
func (f *goobjFile) pcln_scan() (secStart uint64, pclntabRVA uint64, pclntab []byte, err error) {
	return 0, 0, nil, fmt.Errorf("pcln not available in go object file")
}

func (f *goobjFile) pcln() (secStart uint64, symtab []byte, pclntabVA uint64, pclntab []byte, err error) {
	// Should never be called. We implement Liner below, callers
	// should use that instead.
	return 0, nil, 0, nil, fmt.Errorf("pcln not available in go object file")
}
