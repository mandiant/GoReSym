...
import (
	...
	// we copy the go src directly, then change every include to github.com/stevemk14ebr/GoReSym/<whatever>
	// this is required since we're using internal files. Our modifications are directly inside the copied source

	"github.com/stevemk14ebr/GoReSym/buildid"
	"github.com/stevemk14ebr/GoReSym/buildinfo"
	"github.com/stevemk14ebr/GoReSym/objfile"
	"github.com/stevemk14ebr/GoReSym/runtime/debug"
)
